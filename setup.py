...
executables = [Executable("S.A.N.E. Assistant.py", base=base, icon='S.A.N.E. Icon.ico')]
...
# Run: 'python setup.py build' to build the directory when new update is finished
