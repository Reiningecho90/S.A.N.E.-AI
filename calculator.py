...
inp_1 = tk.Button(root, text="1", bg='gray22', fg='black', width=5, height=2, command=lambda: press(1))
inp_1.pack()
inp_1.place(x=0, y=30)
inp_2 = tk.Button(root, text="2", bg='gray22', fg='black', width=5, height=2, command=lambda: press(2))
inp_2.pack()
inp_2.place(x=45, y=30)
inp_3 = tk.Button(root, text="3", bg='gray22', fg='black', width=5, height=2, command=lambda: press(3))
inp_3.pack()
inp_3.place(x=90, y=30)
inp_4 = tk.Button(root, text="4", bg='gray22', fg='black', width=5, height=2, command=lambda: press(4))
inp_4.pack()
inp_4.place(x=0, y=71)
inp_5 = tk.Button(root, text="5", bg='gray22', fg='black', width=5, height=2, command=lambda: press(5))
inp_5.pack()
inp_5.place(x=45, y=71)
inp_6 = tk.Button(root, text="6", bg='gray22', fg='black', width=5, height=2, command=lambda: press(6))
inp_6.pack()
inp_6.place(x=90, y=71)
inp_7 = tk.Button(root, text="7", bg='gray22', fg='black', width=5, height=2, command=lambda: press(7))
inp_7.pack()
inp_7.place(x=0, y=112)
inp_8 = tk.Button(root, text="8", bg='gray22', fg='black', width=5, height=2, command=lambda: press(8))
inp_8.pack()
inp_8.place(x=45, y=112)
inp_9 = tk.Button(root, text="9", bg='gray22', fg='black', width=5, height=2, command=lambda: press(9))
inp_9.pack()
